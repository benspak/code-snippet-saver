...
const SnippetListItem = ({ snippet }) => {
	...
	return (
		<>
			{isEditing && (
				<Modal onClose={handleModalClose} headerContent={`Editing Snippet: ${title}`}>
					<SnippetForm initialValues={getInitialSnippetValues()} onEditSubmit={handleModalClose} />
				</Modal>
			)}
			<div className="snippet">
				...
				>
					...
					<div style={{ display: 'flex', flexDirection: 'row', columnGap: '5px' }}>
						<i className="material-icons" onClick={() => handleCopy(title, code)}>
							content_copy
						</i>
						<i className="material-icons" onClick={() => handleEdit()}>
							edit
						</i>
...
export const SnippetList = () => {
	...
	return (
		<div className="snippets-container">
			...
			{snippets.length === 0 && (
				<div className="snippets-container">
					<h2>Looks like you have no snippets yet :(</h2>
					<h2>Create a Snippet Above!</h2>
				</div>
			)}
